...
class DBServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetOrderByUser = channel.unary_unary(
                ...
                response_deserializer=goods__store__pb2.OrderResponseList.FromString,
                _registered_method=True)
        self.CancelOrderById = channel.unary_unary(
                '/goodsstore.DBService/CancelOrderById',
                request_serializer=goods__store__pb2.OrderId.SerializeToString,
                response_deserializer=goods__store__pb2.Empty.FromString,
                _registered_method=True)
...
def add_DBServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'CancelOrderById': grpc.unary_unary_rpc_method_handler(
                    servicer.CancelOrderById,
                    request_deserializer=goods__store__pb2.OrderId.FromString,
                    response_serializer=goods__store__pb2.Empty.SerializeToString,
            ),
    }
